...
namespace ExitoLogGames.App.Comandos
{
    class Program
    {
        private static IRepositorioCompradores reco = new RepositorioCompradores(new Connection());
        private static IRepositorioVendedores reve = new RepositorioVendedores(new Connection());
        private static IRepositorioAdministradores read = new RepositorioAdministradores(new Connection());
